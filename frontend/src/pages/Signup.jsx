        ...
        <div className="flex flex-col items-center justify-center min-h-[80vh]">
            <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden pt-8 pb-10 px-8 transition-colors duration-200">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Start tracking your study progress</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button
                        type="submit"
                        className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 rounded-lg shadow-md transition-all transform hover:-translate-y-0.5 mt-2"
                    >
                        Sign Up
                    </button>
                </form>
